...
public class Register extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            database.child("Usuario").child(id_auth).setValue(datos).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task2) {
                                    if (task2.isSuccessful()){
                                        ...
                                        Toast.makeText(Register.this, "createUserWithEmail:failure",
    ...
    private void updateUI(FirebaseUser user) {
        if (user!=null){
            Toast.makeText(Register.this, "Usuario creado correctamente",
                    Toast.LENGTH_SHORT).show();
            startActivity(new Intent(Register.this, MapsActivityCliente.class));
            finish();
        }
